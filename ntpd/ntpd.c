 ...
 * Debugging flag
 */
volatile int debug = 1;		/* No debugging by default */
#endif
...
{
        msyslog(LOG_NOTICE, "Danish process_commandline starts");
	int optct;
...
{
        msyslog(LOG_NOTICE, "Danish SIM starts");
...
{
        msyslog(LOG_NOTICE, "Danish SIM WINNT starts");
